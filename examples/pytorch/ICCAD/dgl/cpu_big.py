...
#Enwiki = citation_graph.load_RMAT('enwiki',300,10)
#Amazon = citation_graph.load_RMAT('amazon',100,10)
#_21M = citation_graph.load_RMAT('21',100,10)  #able
#_22M = citation_graph.load_RMAT('22',100,10)  #able
#_23M = citation_graph.load_RMAT('23',50,10)  #able
#A = citation_graph.load_RMAT('A',100,10)  #able
D = citation_graph.load_RMAT('D',64,10)  #able
...
#ModelList   = [GraphSAGE, SGConv, TAGCN]
result = []
for d in DatasetList:
    ...
    for Net in ModelList: 
        ...
        t,t_val = inference(model, d, epochs=5, device=device)
